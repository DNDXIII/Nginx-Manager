import { queryParameters, fetchJson } from '../node_modules/admin-on-rest/src/util/fetch';
import {
    GET_LIST,
    GET_ONE,
    GET_MANY,
    ...
    UPDATE,
    DELETE,
} from '../node_modules/admin-on-rest/src/rest/types';
...
export default (apiUrl, httpClient = fetchJson) => {
      ...
      /*  case GET_MANY: {
        ...
        case GET_MANY_REFERENCE: {
            ...
            const query = {
                sort: JSON.stringify([field, order]),
                range: JSON.stringify([(page - 1) * perPage, (page * perPage) - 1]),
                filter: JSON.stringify({ ...params.filter, [params.target]: params.restId }),
            };
            url = `${apiUrl}/${resource}?${queryParameters(query)}`;
            break;
        }*/
    ...
    const convertHTTPResponseToREST = (response, type, resource, params) => {
        ...
        case CREATE:
            return { data: { ...params.data, restId: json.restId } };
        default:
            return { data: json };
        }
    };
